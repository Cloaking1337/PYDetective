...
class PYDetectiveBaseTest(unittest.TestCase):
    def setUp(self):
        """PYDetective Base Test Setup.

        Does common setup tasks for base PYDetective tests.
        ...
        excluded_sites_path = os.path.join(os.path.dirname(os.path.realpath(PYDetective.__file__)), "tests/.excluded_sites")
        try:
    ...
    def username_check(self, username_list, site_list, exist_check=True):
        ...
        for username in username_list:
            results = PYDetective.PYDetective(username,
                                        site_data,
                                        self.query_notify,
                                        tor=self.tor,
