"""PYDetective: Supported Site Listing
...
with open("PYDetective/resources/data.json", "r", encoding="utf-8") as data_file:
...
with open("PYDetective/resources/data.json", "w") as data_file:
